...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'axel?', fromMe: true, desc: Lang.ALIVE_DESC}, (async (message, match) => {
        ...
        if (Config.ALIVEMSG == 'default') {
            ...
            await message.client.sendMessage(message.jid,'```For you begawo, always``` ' , MessageType.text);
        }
        else {
    ...
    Asena.addCommand({pattern: 'axel?', fromMe: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
